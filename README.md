...
- [Kernel Header](#kernel-header-configuration)
...
| output-style    | "white"       | A format string with each word seperated by dots that describes the style of the text                               |
| seperator-style | "white"       | A format string with each word seperated by dots that describes the style of the between username and hostname      |
...
| Value          | Description                                                                                                   |
|----------------|---------------------------------------------------------------------------------------------------------------|
| pre-text-style | A format string with each word seperated by dots that describes the style of the text that before this module |
| pre-text       | Text that comes before this module                                                                            |
